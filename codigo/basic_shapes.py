...
def createTextureTransparentNormalsCube(image_filename):
    # Defining locations,texture coordinates and normals for each vertex of the shape
    delta = 0.08
    vertices = [
        ...
        -0.5, 0.5, 0.5,            0, 0, 0, 0, 1,
        # Z-
        -0.5, -0.5, -0.5,          0, delta, 0, 0, -1,
        0.5, -0.5, -0.5,           delta, delta, 0, 0, -1,
        0.5, 0.5, -0.5,            delta, 0, 0, 0, -1,
        -0.5, 0.5, -0.5,           0, 0, 0, 0, -1,

        # X+
        0.5, -0.5, -0.5,           0, delta, 1, 0, 0,
        0.5, 0.5, -0.5,            delta, delta, 1, 0, 0,
        0.5, 0.5, 0.5,             delta, 0, 1, 0, 0,
        0.5, -0.5, 0.5,            0, 0, 1, 0, 0,
        # X-
        -0.5, -0.5, -0.5,          0, delta, -1, 0, 0,
        -0.5, 0.5, -0.5,           delta, delta, -1, 0, 0,
        ...
        -0.5, -0.5, 0.5,           0, 0, -1, 0, 0,
        # Y+
        -0.5, 0.5, -0.5,           0, delta, 0, 1, 0,
        0.5, 0.5, -0.5,            delta, delta, 0, 1, 0,
        0.5, 0.5, 0.5,             delta, 0, 0, 1, 0,
        -0.5, 0.5, 0.5,            0, 0, 0, 1, 0,
        # Y-
        -0.5, -0.5, -0.5,          0, delta, 0, -1, 0,
        0.5, -0.5, -0.5,           delta, delta, 0, -1, 0,
