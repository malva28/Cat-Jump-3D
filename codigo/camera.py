...
class CameraXYZ(_Camera):
    ...
    def rotate_center_z(self, angle):
        ...
        self._pos.set_x(rad * _cos(angle))
        self._pos.set_y(rad * _sin(angle))
    ...
    def __str__(self):
        ...
        r = _CAMERA_ROUNDED
        msg = 'Camera: {12}\nAngle: {0}\nRad vel: {1}, Center angle: {2}\nXYZ eye pos: ({3},{4},{5})\nXYZ center ' \
              'pos: ({6},{7},{8})\nXYZ up vector: ({9},{10},{11})'
        return msg.format(round(self._angle, r), round(self._radVel, r),
                          round(self._centerAngle, r),
                          round(x, r),
                          round(y, r),
