...
if __name__ == "__main__":
    ...
    gpuDice = es.toGPUShape(createDice("textures/bricks.jpg"), GL_REPEAT, GL_LINEAR)
    gpuDiceBlue = es.toGPUShape(createDice("textures/dice_blue.jpg"), GL_REPEAT, GL_LINEAR)
